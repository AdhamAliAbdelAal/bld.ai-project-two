    ...
    return (
        <footer className='fluid bg-dark text-white m-0 mt-5'>
            ...
            <div className="fluid mx-auto w-100 row">
                <div className="row col-6 footer-links p-0 m-0">
                    <div className="col-4">Udemy Business</div>
                    <div className="col-4">Careers</div>
                    <div className="col-4">Terms</div>
                    <div className="col-4">Teach on Udemy</div>
                    <div className="col-4">Blog</div>
                    <div className="col-4">Privacy policy</div>
                    <div className="col-4">Get the app</div>
                    <div className="col-4">Help and Support</div>
                    <div className="col-4">Cookie settings</div>
                    <div className="col-4">About us</div>
                    <div className="col-4">Affiliate</div>
                    <div className="col-4">Sitemap</div>
                    <div className="col-4">Contact us</div>
                    <div className="col-4">Investors</div>
                    <div className="col-4">Accessibility statement</div>
                </div>
